            ...
            <div class="col-md-12">
			  ...
			  <br/>
                <table class="table table-striped table-hover table-bordered">
                  ...
                  <tbody>
<?php
$f=mysqli_query($conn, "select * from goods where status='PENDING'");
                    ...
                    <tr>
                      ...
                      <td>
						<form method="post">
							...
							<input type="submit" name="bill" value="Insert Charges" class="btn btn-success btn-xs"/>
						</form>
					  </td>
                    </tr>
<?php

			...
			<form role="form" id="templatemo-preferences-form" method="post">
                <div class="row">
                  <div class="col-md-6 margin-bottom-15">
                    ...
                    <input type="password" class="form-control" id="name" name="pass" placeholder="Preferred Password">                  
                  </div>
				  <div class="col-md-6 margin-bottom-15">
                    <label for="firstName" class="control-label">Confirm Password</label>
                    <input type="password" class="form-control" id="location" name="passc" placeholder="Confirm Your Password">                  
                  </div>
...
if(isset($_POST['update']))
{
	...
	if($pass==$passc)
	{
		...
		if($upd)
		{
			header("location:passad.php?suc=");
		}
	}
	else
	{
		header("location:passad.php?fail=");
	}
}
if(isset($_GET['suc']))
{
